...
export const home = {
  fr: {
    ...
    heroSub: "Des cours de français pour s'intégrer vraiment dans la vie locale — à Chalabre et en Occitanie.",
    ...
    courses: [
      {
        ...
        description: "Mairie, commerces, médecin, voisinage — le français qui sert vraiment dans la vie de Chalabre et d'Occitanie.",
        anchor: '#c1',
      },
      {
        number: '02',
    ...
    aboutParagraph2: "Mes cours partent de la réalité de l'Occitanie : les marchés, la mairie, les voisins, les médecins. Un français qui sert, appris dans un cadre bienveillant et sans jugement.",
  ...
  en: {
    ...
    heroSub: "French courses to help you truly settle into local life — in Chalabre and Occitanie.",
    ...
    courses: [
      {
        ...
        description: "Town hall, shops, doctor, neighbours — the French you'll actually use living in Chalabre and Occitanie.",
        anchor: '#c1',
      },
      {
        number: '02',
    ...
    aboutParagraph2: 'My lessons start from real life in Occitanie : markets, the town hall, neighbours, doctors. French that actually serves you, taught in a supportive, judgement-free setting.',
...
export const cours = {
  fr: {
    ...
    heroSub: 'Des cours de français conçus pour la vie réelle à Chalabre et en Occitanie — en groupe, en atelier, ou en individuel.',
    ...
    courses: [
      {
        ...
        summary: 'Des situations de la vie réelle — médecin, garagiste, voisins, téléphone — pour un français qui sert vraiment à Chalabre et en Occitanie.',
        programme: [
  ...
  en: {
    ...
    heroSub: 'French courses designed for real life in Chalabre and Occitanie — in groups, workshops, or one-to-one.',
    ...
    courses: [
      {
        ...
        summary: "Real-life situations — the doctor, the mechanic, neighbours, phone calls — for French that's genuinely useful in Chalabre and Occitanie.",
        programme: [
